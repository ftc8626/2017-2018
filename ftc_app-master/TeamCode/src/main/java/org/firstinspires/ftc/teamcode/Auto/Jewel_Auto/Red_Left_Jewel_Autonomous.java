 ...
 */
@Autonomous(name="Red_Left_Jewel_Autonomous", group="Jewel")
public class Red_Left_Jewel_Autonomous extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive() && robot.rightColorSensor.blue() < 2 && robot.rightFrontMotor.getCurrentPosition() < 10 ) {
